...
module alu (
    ...
    wire [31:0] addition_result = i_op1 + i_op2;
    wire [31:0] subtraction_result = i_op1 - i_op2;
    wire [31:0] shift_left_result = i_op1 << i_op2[4:0];
    wire [31:0] set_less_than_result = {31'b0, o_slt};
    wire [31:0] exclusive_or_result = i_op1 ^ i_op2;
    wire [31:0] shift_right_result = i_op1 >> i_op2[4:0];
    wire [31:0] shift_right_arithmetic_result = $signed(i_op1) >>> i_op2[4:0];
    wire [31:0] or_result = i_op1 | i_op2;
    wire [31:0] and_result = i_op1 & i_op2;

    assign o_result = (i_opsel == 3'b000) ? (i_sub ? subtraction_result : addition_result) :
                      (i_opsel == 3'b001) ? shift_left_result :
                      (i_opsel == 3'b010 || i_opsel == 3'b011) ? set_less_than_result :
                      (i_opsel == 3'b100) ? exclusive_or_result :
                      (i_opsel == 3'b101) ? (i_arith ? shift_right_arithmetic_result : shift_right_result) :
