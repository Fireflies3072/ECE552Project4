...
module rf #(
    ...
    // Read registers
    wire[31:0] rs1_rdata = i_rs1_raddr == 5'b0 ? 32'b0 : registers[i_rs1_raddr];
    wire[31:0] rs2_rdata = i_rs2_raddr == 5'b0 ? 32'b0 : registers[i_rs2_raddr];

    // Bypass logic
    assign o_rs1_rdata = (BYPASS_EN && i_rd_wen && i_rd_waddr != 5'b0 && i_rd_waddr == i_rs1_raddr) ? i_rd_wdata : rs1_rdata;
    assign o_rs2_rdata = (BYPASS_EN && i_rd_wen && i_rd_waddr != 5'b0 && i_rd_waddr == i_rs2_raddr) ? i_rd_wdata : rs2_rdata;
