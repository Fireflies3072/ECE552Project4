            ...
            case (i_funct3)
                3'b000: begin // sb
                    case (i_alu_result[1:0])
                        2'b00: begin mem_dmem_mask = 4'b0001; mem_dmem_wdata = {24'b0, i_rs2_data[7:0]}; end
                        2'b01: begin mem_dmem_mask = 4'b0010; mem_dmem_wdata = {16'b0, i_rs2_data[7:0], 8'b0}; end
                        2'b10: begin mem_dmem_mask = 4'b0100; mem_dmem_wdata = {8'b0, i_rs2_data[7:0], 16'b0}; end
